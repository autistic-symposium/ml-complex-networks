...
def main():
    ...
    for net_type in INPUT_FILE:
        for NUM_SETS  in SAMPLINGS_SETS:
            ...
            OUTPUT_FILE_TRAIN = './output/social_train_' + net_type + str(NUM_SETS) + '_.data' 
            OUTPUT_FILE_TEST = './output/social_test_'   + net_type + str(NUM_SETS) + '_.data' 
